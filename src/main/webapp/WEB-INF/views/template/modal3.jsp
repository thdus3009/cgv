            ...
            <div class="modal-content">
               ...
               <form id="form" name="form" method="post"
                  ...
                  <div class="modal-header" style="background-color: #333; position: relative;">
                     ...
                     <button id="exit" type="button" class="close modal3_exit" data-dismiss="modal" style="background: url('../images/myPage/sprite_btn.png') no-repeat -72px -62px;"></button>
                  </div>
            ...
            <div class="modal-content">
               ...
               <form id="form" name="form" method="post"
                  ...
                  <div class="modal-header" style="background-color: #333; position: relative;">
                     ...
                     <button id="exit2" type="button" class="close modal3_exit" data-dismiss="modal" style="background: url('../images/myPage/sprite_btn.png') no-repeat -72px -62px;"></button>
                  </div>

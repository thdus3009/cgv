		...
		<div class="contents">
			<div class="wrap_login">
				<ul class="tab_menu_round">
					<li>
						<a class="lo" href="#">회원정보 수정</a>
					</li>
				</ul>
				<div class="box_login">
					<form class="box_form" action="./memberUpdate" id="frm" method="post">
						<fieldset>
							<div class="login_input">
								<h2>아이디</h2>
								<input id="userID" class="id check" type="text" style="display: inline-block;" name="uid" readonly="true" value="${memberVO.uid}"> 
								...
								<h2>비밀번호</h2>
								<input id="userPWD" class="check" type="password" required="required">
								<p id="pwd1c"></p>
								
								<h2>비밀번호 재확인</h2>
								<input id="userPWD2" class="check" type="password" style="display: inline-block;" name="pwd" required="required">
<!-- 								<button type="button" style="display: inline-block; color:#ffffff; height:38px; width: 85px; margin-top: 0px;margin-right: 200px;">확인</button> -->
								...
								<h2>이름</h2>
								<input id="name" class="text check" type="text" name="name" value="${memberVO.name}">
								...
								<h2>전화번호</h2>
								<input id="phone" class="text check" type="text" placeholder="' - ' 없이 입력해 주세요" maxlength="11" name="phone" value="${memberVO.phone}">
								
								<h2>이메일</h2>
								<input id="email" class="check" type="email" placeholder="선택입력" name="email" value="${memberVO.email}">
							</div>
						
						</fieldset>
						<button id="btn" type="submit"><span>수정</span></button>
					</form>

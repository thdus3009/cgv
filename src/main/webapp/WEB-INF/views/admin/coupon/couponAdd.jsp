				...
				<div class="container-fluid">
					...
					style="width: 500px; margin: 0 auto;">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="serialNum" required="required">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="date" class="form-control" id="sIssuance" required="required">
						</div>
						<div class="form-group">
							<label for="intro">사용기간(끝)</label> 
							<input type="date" class="form-control" id="eIssuance" required="required">
						</div>
						<div class="btn_s">
